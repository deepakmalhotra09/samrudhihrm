...
return [
   ...
   */
    ...
    "keyRequired" => 'Site Key and Secret Key is required',
    // Employees
    ...
    'updateSuccess' => 'Google Recaptcha setting updated successfully',
    'errorCaptcha' => 'Site key and Secret key is required',
