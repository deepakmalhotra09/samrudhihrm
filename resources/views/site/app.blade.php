...
<script type='text/javascript' src='https://platform-api.sharethis.com/js/sharethis.js#property=61c070955d828a00190e406a&product=sop' async='async'></script>    
<script src="//code.tidio.co/usidmomv3uputmlxozn2f4inhdkdmoxy.js" async></script>
</head><!--/head-->
<!-- Global site tag (gtag.js) - Google Analytics -->
<script async src="https://www.googletagmanager.com/gtag/js?id=G-7FYBPJFQE4"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'G-7FYBPJFQE4');
</script>
<body class="homepage">
